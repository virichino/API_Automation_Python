...
class TestSpaces:
    ...
    @pytest.mark.crud
    @pytest.mark.spaces              
    def test_get_all_spaces(self, log_test_name):
        """
    ...
    @pytest.mark.crud
    @pytest.mark.spaces           
    def test_create_space(self,log_test_name):
        """
    ...
    @pytest.mark.crud
    @pytest.mark.spaces   
    def test_update_space(self, create_space, log_test_name):
        """
    ...
    @pytest.mark.crud
    @pytest.mark.spaces  
    def test_delete_space(self, create_space, log_test_name):
        """
    ...
    @pytest.mark.spaces        
    def test_create_max_number_of_space(self,delete_list_spaces,log_test_name):
        """
        Test to create a space
        """
        url_create_space = f"{self.url_clickup}team/{self.team_id}/space"
    ...
    @pytest.mark.functional
    @pytest.mark.spaces           
    def test_create_space_with_same_name(self, delete_list_spaces, log_test_name) :
        """
        Test to verify if a space with the same name can be created
        """
        body_last_space = {
            "name": f"New Space Create By API",
            "multiple_assignees": True,
            "features": {
                "due_dates": {
                "enabled": True,
