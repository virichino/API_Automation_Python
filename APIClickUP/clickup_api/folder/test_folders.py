"""
This module contains the test cases for the folders endpoint
"""
import logging
import pytest
import allure
...
class TestFolders:
    """
    Class to test the folders endpoint
    """
    @classmethod
    def setup_class(cls):
        """
    ...
    @pytest.mark.crud
    @pytest.mark.folders
    def test_get_all_folders(self,create_space,log_test_name):# pylint: disable=unused-argument
        """
    ...
    @pytest.mark.crud
    @pytest.mark.folders
    def test_create_folder(self,create_space,log_test_name): # pylint: disable=unused-argument
        """
    ...
    @pytest.mark.crud
    @pytest.mark.folders
    def test_update_folder(self,create_folder,log_test_name):# pylint: disable=unused-argument
        """
    ...
    @pytest.mark.crud
    @pytest.mark.folders
    def test_delete_folder(self,create_folder,log_test_name):# pylint: disable=unused-argument
        """
